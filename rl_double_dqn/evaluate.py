...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate Double DQN checkpoints for speed_racer (rl_double_dqn)")
    parser.add_argument("--runs-dir", type=Path, default=Path("rl_double_dqn/runs"))
